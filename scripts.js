...
//if statements voor onload script van de html pagina's
if (typeof document.getElementById("aboutMe") !== "undefined" && document.getElementById("aboutMe") !== null)  { //gebruik onload script voor index.html
window.onload = indexLoadJS;
}
else if (typeof document.getElementById("hannahParagraph") !== "undefined" && document.getElementById("hannahParagraph") !== null) { //gebruik onload script voor hannah.html
